...
syn keyword sqlKeyword QUERY_GOVERNOR_COST_LIMIT QUOTED_IDENTIFIER QUOTENAME RADIANS RAISERROR RAND READ READS READTEXT REAL RECONFIGURE RECURSIVE REF REFERENCES REFERENCING RELATIVE REMOTE_PROC_TRANSACTIONS REPLACE REPLICATE REPLICATION RESTORE RESTRICT RESULT RETURN RETURNS REVERSE REVOKE RIGHT ROLE ROLLBACK ROLLUP ROUND ROUTINE ROW ROWCOUNT ROWCOUNT_BIG ROWGUIDCOL ROWS RTRIM RULE READUNCOMMITTED
